...
public class ListItemClickAdapter extends BaseAdapter {
    ...
    public ListItemClickAdapter(Context context, int vg, ArrayList<String> nameList, ArrayList<String> phoneNumList){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(rowView==null){
            ...
            viewHolder.heart.setImageResource(R.drawable.heartbreak);
